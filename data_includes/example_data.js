...
var texts = [
        [["Where are you going?<br>", "Motel’s that way.<br>", "Would you believe me if I told you I know a shortcut?<br>", "So, there’s this party tonight… August, no!<br>", "But it’s perfect!<br>", "It’s my last night in Aberdeen!<br>", "I’ll never be in this town again!<br>", "No, we can’t.<br>", "But it’ll be like a going away party!<br>", "And I want you to come with me!<br>", "You can meet the friends I made while I was here!<br>", "Mom will freak out if we don’t come back to the motel tonight.<br>", "She’ll never know.<br>"],
      [[0, 3, 6, 9, 12], [1, 4, 7, 10], [2, 5, 8, 11], [3, 6, 9, 12]]],
    [["You saved my life, you know.<br>", "But the problem with that is that I wanted to die.<br>", "Look, I… No, I know.<br>", "I get why you did it.<br>", "I would have jumped in after someone, too.<br>", "But what I don’t understand is how it all went down.<br>", "What do you mean?<br>", "You weren’t just some random person walking down the street who saw me jump.<br>", "You’re August’s brother.<br>", "We’re connected through him.<br>", "How did you know I was going to be there?<br>", "How did you know to come?<br>", "I don’t know.<br>", "I thought you were him at first.<br>", "I know that’s stupid, but I thought you were him and I wanted so badly for you to be him.<br>"],
      [[0, 3, 6, 9, 12], [1, 4, 7, 10, 13], [2, 5, 8, 11, 14], [3, 6, 9, 12], [4, 7, 10, 13]]],
    [["Alf: You we're talking about uh Bad Manners at the weekend but I'm uh in work all weekend<br>", "Beth: Are you Why Sure you won't be able to get a bus in and out of Downpatrick<br>", "Alf: And we we're started 2 sylls Well I'm still working I'm still on duty<br>", "Beth: Are you not going out for a drink<br>", "Alf: I won't be able to<br>", "Beth: At all<br>", "Alf: Well not really Well I'm working Saturday and Sunday but uhm Saturday Sunday Monday Tuesday Wednesday Thursday and then Friday I'm away But the fact is we're moving sort of half moving back in now Most of the work's finished<br>", "Beth: Ah Aye did you get much done last Sunday<br>", "Alf: Uhm yeah a good bit yeah<br>", "Beth: Dragged out of our beds<br>", "Alf: I got shouted at like all day that oh you were here sure Ah I got a good bit done like but we're we're sort of moving back in so<br>", "Beth: Was Leslie pissed off<br>", "Alf: Don't know Why<br>", "Beth: Did you not see him<br>", "Alf: I did Aye he's alright<br>", "Beth: Yeah<br>", "Alf: Yeah He's dead-on<br>", "Beth: Okay<br>"],
      [[0, 4, 8, 12, 16], [1, 5, 9, 13, 17], [2, 6, 10, 14], [3, 7, 11, 15]]],
    [["Sue: So I'm just going to like have a drink here and then go up afterwards<br>", "Bob: Right<br>", "Sue: What about you<br>", "Bob: Well Bad Manners are playing tomorrow night<br>", "Sue: Oh yes Yes Saoirse was saying Jessie's going Are you going as well<br>", "Bob: And I love them Jessie's not going<br>", "Sue: Oh is she not<br>", "Bob: Not as far as I know<br>", "Sue: Oh I must 've got confused between you and Jessie<br>", "Bob: Cos Jessie uhm was saying she wants to go on a binge on Saint Paddy's Day all day So she wants to save herself Saturday night<br>", "Sue: Oh yeah that's right Ah<br>", "Bob: Which is just nonsense<br>", "Sue: It kind of is isn't it<br>", "Bob: Yeah But Bad Manners is on and then Crescent Arts is on after that<br>", "Sue: I know it is I know and I was just torn between<br>", "Bob: Mm and I was hoping you 'd go<br>", "Sue: I know And I was going to but then we heard about this party and I think it is actually going to be really good<br>", "Bob: Uh-huh<br>", "Sue: So it 'd be really good if you could come up afterwards or something<br>", "Bob: Right Give me the hold on and I 'll get a pen<br>"],
      [[0, 4, 8, 12, 16], [1, 5, 9, 13, 17], [2, 6, 10, 14, 18], [3, 7, 11, 15, 19], [4, 8, 12, 16]]],
    [["Lisa: Yeah Where<br>", "Kate: We went to the second-hand shop in Stillorgan You know that one that uhm that's does the debs dresses<br>", "Lisa: Where is it<br>", "Kate: It's in Stillorgan<br>", "Lisa: No I don't think I know it<br>", "Kate: Well Rosemary and I went in for a look and uhm I found a lovely red dress And I was like delighted with it and everything And I brought mum up to see it and she totally ditched it<br>", "Lisa: Yeah Yeah Why<br>", "Kate: She said it looked like she was you she was saying it didn't do anything for my hips It made my hips look big and like my you know my bum and hips and everything I was really excited cos I had the dress and then I just<br>", "Lisa: But did you like it<br>", "Kate: Yeah<br>", "Lisa: But she turned you off it<br>", "Kate: Yeah well I mean I'm hardly going to wear it now seeing everyone thinking I 've big hips Hip girl I 'll be called hippy Hippo<br>"],
    ...
    [["Olivetti has denied that it violated Cocom rules, asserting that the reported shipments were properly licensed by the Italian authorities.", "Although the legality of these sales is still an open question,", "the disclosure couldn't be better timed to support the position of export-control hawks in the Pentagon and the intelligence community.", "'It seems to me that a story like this breaks just before every important Cocom meeting,' said a Washington lobbyist for a number of U.S. computer companies.", "The Bush administration has sent conflicting signals about its export-control policies,", "reflecting unhealed divisions among several competing agencies.", "Last summer, Mr. Bush moved the administration in the direction of gradual liberalization", "when he told a North Atlantic Treaty Organization meeting that he would allow some exceptions to the Cocom embargo of strategic goods.", "But more recently, the Pentagon and the Commerce Department openly feuded over the extent to which Cocom should liberalize exports of personal computers to the bloc.", "However, these agencies generally agree that the West should be cautious about any further liberalization.", "'There's no evidence that the Soviet program to (illegally) acquire Western technology has diminished,' said a State Department spokesman."],
      [[0, 3, 6, 9], [1, 4, 7, 10], [2, 5, 8]]],
    [["The debate that a handful of Texas multi-millionnaires close to the Bush family have cleverly manufactured over John Kerry's war record is absurd in every way.<br>", "The charges that they have put some vets up to making against Kerry are false and can be demonstrated by the historical record to be false.<br>", "Most of those making the charges have even flip-flopped, contradicting themselves.<br>", "Or they weren't eyewitnesses and are just lying.<br>", "But to address the substance of this Big Lie is to risk falling into its logic.<br>", "The true absurdity of the entire situation is easily appreciated when we consider that George W. Bush never showed any bravery at all at any point in his life.<br>", "He has never lived in a war zone.<br>", "If some of John Kerry's wounds were superficial, Bush received no wounds.<br>"],
      [[0, 2, 4, 6], [1, 3, 5, 7], [2, 4, 6], [3, 5, 7]]],
    [["When we arrived at the homesite yesterday,", "a contractor was already filling in the trench that brought the power and phone cables to the nearly completed workshop.", "An hour later, he had installed the meter", "and we were good to go as far as electrical power is concerned.", "I was pleased to see that the power cables were 3/4 inch in diameter,", "as the run from the transformer is about 200 feet.", "The telephone company still needs to do its peculiar magic", "before we can log onto the Internet,", "but that too should be handled in the next few days.", "Unlike some family and friends who are content to live 'off the grid' as a solution to finding a satisfying lifestyle,", "I feel that we live in a connected world", "and a satisfying lifestyle has to involve involve open communication."],
      [[0, 3, 6, 9], [1, 4, 7, 10], [2, 5, 8, 11], [3, 6, 9]]],
    [["Are they really any safer, now?<br>", "Seeing the efforts big business has been making to remove government oversight where it can,<br>", "I'm not terribly confident about that.<br>", "UL isn't government.<br>", "From my experience (mostly residential lighting equipment),<br>", "I haven't noticed any relaxation of standards for fire or electrical safety.<br>", "If anytthing, It has been just the opposite.<br>", "Competition appears to be good for UL.<br>", "Manufacturers have options including ETL and CSA (Canadian Standards Association) and others<br>", "so there are alternatives.<br>", "That helps costs and speed of testing.<br>", "They all test to the same standards.<br>"],
      [[0, 3, 6, 9], [1, 4, 7, 10], [2, 5, 8, 11], [3, 6, 9]]],
]
